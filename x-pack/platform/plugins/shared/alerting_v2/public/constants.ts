...
export const ALERTING_V2_MIGRATION_APP_ID = 'migration';
...
export const ALERTING_V2_MIGRATION_BASE_PATH = `/app/management/${ALERTING_V2_SECTION_ID}/${ALERTING_V2_MIGRATION_APP_ID}`;
